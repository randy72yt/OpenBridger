	...
	anonymousRequestBodyLimit := middleware.AnonymousRequestBodyLimit()
	{
		...
		userRoute := apiRouter.Group("/user")
		{
			...
			selfRoute.Use(middleware.DisableCache(), middleware.UserAuth())
			{
				...
				selfRoute.POST("/pay", middleware.RequireOnlinePayment(), middleware.CriticalRateLimit(), controller.RequestEpay)
				selfRoute.POST("/amount", middleware.RequireOnlinePayment(), controller.RequestAmount)
				selfRoute.POST("/stripe/pay", middleware.RequireOnlinePayment(), middleware.CriticalRateLimit(), controller.RequestStripePay)
				selfRoute.POST("/stripe/amount", middleware.RequireOnlinePayment(), controller.RequestStripeAmount)
				selfRoute.POST("/creem/pay", middleware.RequireOnlinePayment(), middleware.CriticalRateLimit(), controller.RequestCreemPay)
				selfRoute.POST("/waffo/amount", middleware.RequireOnlinePayment(), controller.RequestWaffoAmount)
				selfRoute.POST("/waffo/pay", middleware.RequireOnlinePayment(), middleware.CriticalRateLimit(), controller.RequestWaffoPay)
				selfRoute.POST("/waffo-pancake/amount", middleware.RequireOnlinePayment(), controller.RequestWaffoPancakeAmount)
				selfRoute.POST("/waffo-pancake/pay", middleware.RequireOnlinePayment(), middleware.CriticalRateLimit(), controller.RequestWaffoPancakePay)
		...
		subscriptionRoute.Use(middleware.UserAuth())
		{
			...
			subscriptionRoute.POST("/balance/pay", middleware.RequireOnlinePayment(), middleware.CriticalRateLimit(), controller.SubscriptionRequestBalancePay)
			subscriptionRoute.POST("/epay/pay", middleware.RequireOnlinePayment(), middleware.CriticalRateLimit(), controller.SubscriptionRequestEpay)
			subscriptionRoute.POST("/stripe/pay", middleware.RequireOnlinePayment(), middleware.CriticalRateLimit(), controller.SubscriptionRequestStripePay)
			subscriptionRoute.POST("/creem/pay", middleware.RequireOnlinePayment(), middleware.CriticalRateLimit(), controller.SubscriptionRequestCreemPay)
			subscriptionRoute.POST("/waffo-pancake/pay", middleware.RequireOnlinePayment(), middleware.CriticalRateLimit(), controller.SubscriptionRequestWaffoPancakePay)
		}
